function [ cluster ] = cluster_entln_import( date )
%CLUSTER_ENTLN_IMPORT gives the cluster ID for the ENTLN file given by date
%   Clusters are determined by cluster_entln.m
%
...
%% Read/Load data
	...
	if import
		...
		data = entln_import(date);
		cluster = cluster_entln(data);
